 ...
 */
#ifndef EEAODVPACKET_H
#define EEAODVPACKET_H
...
enum MessageType
{
    EEAODVTYPE_RREQ = 1,    //!< EEAODVTYPE_RREQ
    EEAODVTYPE_RREP = 2,    //!< EEAODVTYPE_RREP
    EEAODVTYPE_RERR = 3,    //!< EEAODVTYPE_RERR
    EEAODVTYPE_RREP_ACK = 4 //!< EEAODVTYPE_RREP_ACK
};
...
class TypeHeader : public Header
{
  public:
    /**
     * constructor
     * \param t the EEAODV RREQ type
     */
    TypeHeader(MessageType t = EEAODVTYPE_RREQ);
