...
{
    static TypeId tid = TypeId("ns3::eeaodv::TypeHeader")
                            .SetParent<Header>()
                            .SetGroupName("Eeaodv")
...
{
    static TypeId tid = TypeId("ns3::eeaodv::RreqHeader")
                            .SetParent<Header>()
                            .SetGroupName("Eeaodv")
...
{
    static TypeId tid = TypeId("ns3::eeaodv::RrepHeader")
                            .SetParent<Header>()
                            .SetGroupName("Eeaodv")
...
{
    static TypeId tid = TypeId("ns3::eeaodv::RrepAckHeader")
                            .SetParent<Header>()
                            .SetGroupName("Eeaodv")
...
{
    static TypeId tid = TypeId("ns3::eeaodv::RerrHeader")
                            .SetParent<Header>()
                            .SetGroupName("Eeaodv")
