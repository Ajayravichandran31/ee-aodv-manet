 ...
 */
#ifndef EEAODV_RQUEUE_H
#define EEAODV_RQUEUE_H
...
/**
 * \ingroup eeaodv
 * \brief EEAODV route request queue
 *
 * Since EEAODV is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
  public:
