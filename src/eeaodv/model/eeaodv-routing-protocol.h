 ...
 */
#ifndef EEAODVROUTINGPROTOCOL_H
#define EEAODVROUTINGPROTOCOL_H

#include "eeaodv-dpd.h"
#include "eeaodv-neighbor.h"
#include "eeaodv-packet.h"
#include "eeaodv-rqueue.h"
#include "eeaodv-rtable.h"
...
class RoutingProtocol : public Ipv4RoutingProtocol
{
  public:
    ...
    static const uint32_t EEAODV_PORT;
  ...
  private:
     ...
     */
    void RecvEeaodv(Ptr<Socket> socket);
    /**
     * Receive RREQ
     * \param p packet
