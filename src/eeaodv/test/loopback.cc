 ...
 * \ingroup eeaodv
 *
 * \brief EEAODV loopback UDP echo test case
 */
 ...
 * \ingroup eeaodv-test
 *
 * \brief EEAODV Loopback test suite
 */
class EeaodvLoopbackTestSuite : public TestSuite
{
  public:
    EeaodvLoopbackTestSuite()
        : TestSuite("routing-eeaodv-loopback", SYSTEM)
    {
        SetDataDir(NS_TEST_SOURCEDIR);
        // UDP Echo loopback test case
        AddTestCase(new LoopbackTestCase(), TestCase::QUICK);
    }
} g_eeaodvLoopbackTestSuite; ///< the test suite
